...
declare class Streams implements StreamsInterface {
     ...
     * @returns Transaction hash if successful, Error object where applicable or null in catch all error case
     */
    setIsEventEmissionOpen(streamsEventId: string, isOpen: boolean): Promise<Hex | Error | null>;
    /**
     ...
     */
    subscribe({ somniaStreamsEventId, ethCalls, context, onData, onError, eventContractSources, topicOverrides, onlyPushChanges }: SubscriptionInitParams): Promise<{
        subscriptionId: string;
        unsubscribe: () => void;
    } | undefined>;
    /**
